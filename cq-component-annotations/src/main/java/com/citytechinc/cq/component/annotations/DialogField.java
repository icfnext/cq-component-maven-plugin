...
public @interface DialogField {
	...
	/**
	 * The weight of the property within the context of its containing tab.
	 * Properties with a greater weight will "sink" to the bottom of the tab
	 * while others will "rise" to the top. If the weight of two properties are
	 * equal, no guarantees are made concerning ordering between the two.
	 * 
	 * 
	 * @return int
	 */
