...
public class HtmlTag extends AbstractXmlElement {
    ...
    public HtmlTag(HtmlTagParameters parameters) {
        ...
        this.tagName = new NameSpacedAttribute<String>(Constants.CQ_NS_URI, Constants.CQ_NS_PREFIX, parameters.getTagName());
    ...
    /**
     * Returns a map containing the single cssClass property keyed by the term 'class'.  This is
     * necessary as class is reserved and getClass has special meaning.
     *
     * @return A map of the string 'class' to the proposed cssClass if one is provided or an empty map if not
     */
