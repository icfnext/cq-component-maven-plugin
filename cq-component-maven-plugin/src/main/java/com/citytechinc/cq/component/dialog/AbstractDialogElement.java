...
public abstract class AbstractDialogElement implements DialogElement{
	...
	public AbstractDialogElement(String primaryType,String nameSpace, String fieldName, Map<String, String> additionalProperties,List<? extends DialogElement> containedElements){
