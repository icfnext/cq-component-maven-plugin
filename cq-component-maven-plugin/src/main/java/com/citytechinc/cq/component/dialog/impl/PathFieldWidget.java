...
public class PathFieldWidget extends AbstractWidget {
	...
	public PathFieldWidget(boolean escapeAmp,boolean hideTrigger, boolean parBrowse, String rootPath,String rootTitle,boolean showTitleInTree, String fieldLabel,
