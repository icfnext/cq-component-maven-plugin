...
public class NumberFieldMaker extends AbstractWidgetMaker{
	...
	public DialogElement make(String xtype, Field widgetField,
		...
		return new NumberFieldWidget(allowDecimals, allowNegative, decimalPrecision, decimalSeparator, fieldLabel, fieldDescription, !isRequired, defaultValue, name, fieldName, additionalProperties, null);
	}
