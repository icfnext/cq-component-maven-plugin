...
public class ComponentMojoUtil {
	...
	public static void buildArchiveFileForProjectAndClassList(
		 ...
		 */
		buildDialogsFromClassList(classList, tempOutputStream, existingArchiveEntryNames, xtypeMap, classLoader, classPool, buildDirectory, componentPathBase, defaultComponentPathSuffix);
