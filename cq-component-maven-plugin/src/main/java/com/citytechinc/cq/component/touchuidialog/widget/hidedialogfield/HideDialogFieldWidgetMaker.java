...
public class HideDialogFieldWidgetMaker extends AbstractTouchUIWidgetMaker<HideDialogFieldWidgetParameters> {
    ...
    @Override
    protected TouchUIDialogElement make(HideDialogFieldWidgetParameters parameters) throws ClassNotFoundException, InvalidComponentFieldException, TouchUIDialogGenerationException, IllegalAccessException, InstantiationException {
