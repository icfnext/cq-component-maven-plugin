...
@TouchUIWidget(annotationClass = MultiField.class, makerClass = MultiFieldWidgetMaker.class, resourceType = MultiFieldWidget.RESOURCE_TYPE, ranking = MultiFieldWidget.RANKING)
public class MultiFieldWidget extends AbstractTouchUIWidget {
    ...
    public MultiFieldWidget(TouchUIWidgetParameters parameters) {
        super(parameters);
    }
