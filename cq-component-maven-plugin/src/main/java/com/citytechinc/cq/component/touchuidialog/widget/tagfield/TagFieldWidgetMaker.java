...
public class TagFieldWidgetMaker extends AbstractTouchUIWidgetMaker<TagFieldWidgetParameters> {
    ...
    @Override
    protected TouchUIDialogElement make(TagFieldWidgetParameters widgetParameters) throws ClassNotFoundException, InvalidComponentFieldException, TouchUIDialogGenerationException, IllegalAccessException, InstantiationException {
